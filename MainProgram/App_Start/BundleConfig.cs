        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include(
                    //  "~/Content/css/font-awesome.css",
                      ...
                      "~/Content/css/theme-color/custom-theme.css",
                      "~/Content/css/sequence-theme.modern-slide-in.css",
                       "~/Content/css/Custom.css",
                        "~/Content/css/Phone.css",
                        "~/Content/css/Mobile/css/Mobile.css",
                         "~/Content/css/Tablet.css",
                       //  "~/Content/bootstrap-3.3.7/dist/css/bootstrap.min.css",
                       //  "~/Content/bootstrap-4.6.1/bootstrap-4.6.1-dist/css/bootstrap.css",
            ...
            bundles.Add(new ScriptBundle("~/Content/js").Include(
                 ...
                 //  "~/Content/bootstrap-4.6.1/bootstrap-4.6.1-dist/js/bootstrap.js"
                  ));
        }
    }
}
