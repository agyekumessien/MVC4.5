...
namespace MainProgram.Edm
{
    ...
    public partial class Post_DBA : IEntityBase
    {
        public Post_DBA()
        {
            this.Post_DBA1 = new HashSet<Post_DBA>();
        ...
        public string PostDBAText { get; set; }
        public string PostDBATitle { get; set; }
        ...
        public Nullable<int> Post_DBA_PostDBAId { get; set; }
        public string PostDBAKu { get; set; }
        ...
        public Nullable<int> Post_DBA2_Id { get; set; }
        ...
        public virtual ICollection<Post_DBA> Post_DBA1 { get; set; }
        public virtual Post_DBA Post_DBA2 { get; set; }
