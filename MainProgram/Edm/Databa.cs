...
namespace MainProgram.Edm
{
    ...
    public partial class Databa : IEntityBase
    {
        public Databa()
        {
            this.Databas1 = new HashSet<Databa>();
        ...
        public Nullable<int> Databas1_Id { get; set; }
        ...
        public virtual ICollection<Databa> Databas1 { get; set; }
        public virtual Databa Databa1 { get; set; }
