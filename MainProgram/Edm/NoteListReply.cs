...
namespace MainProgram.Edm
{
    ...
    public partial class NoteListReply : IEntityBase
    {
        public NoteListReply()
        {
            this.NoteListReplies1 = new HashSet<NoteListReply>();
        }
        ...
        public Nullable<int> NoteListReply1_Id { get; set; }
        ...
        public virtual ICollection<NoteListReply> NoteListReplies1 { get; set; }
        public virtual NoteListReply NoteListReply1 { get; set; }
