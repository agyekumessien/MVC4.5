...
namespace MainProgram.Edm
{
    ...
    public partial class AjaxReply : IEntityBase
    {
        public AjaxReply()
        {
            this.AjaxReplies1 = new HashSet<AjaxReply>();
        }
    
        public int Id { get; set; }
        public int AjaxRId { get; set; }
        public string AjaxRText { get; set; }
        public string AjaxRTitle { get; set; }
        ...
        public string AjaxRSku { get; set; }
        public string Title { get; set; }
        public string ImagePath { get; set; }
        public string LanguageName { get; set; }
        public string UserName { get; set; }
        public Nullable<int> AjaxReplies_AjaxRId { get; set; }
        public string Reply { get; set; }
        public int TID { get; set; }
        public Nullable<int> AjaxReply1_Id { get; set; }
        ...
        public virtual Ajax Ajax { get; set; }
        public virtual ICollection<AjaxReply> AjaxReplies1 { get; set; }
        public virtual AjaxReply AjaxReply1 { get; set; }
