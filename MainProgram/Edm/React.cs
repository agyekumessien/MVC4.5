...
namespace MainProgram.Edm
{
    ...
    public partial class React : IEntityBase
    {
        public React()
        {
            this.ReactReplies = new HashSet<ReactReply>();
            this.Reacts1 = new HashSet<React>();
        }
        ...
        public virtual ICollection<React> Reacts1 { get; set; }
        public virtual React React1 { get; set; }
