...
namespace MainProgram.Edm
{
    ...
    public partial class DotNet : IEntityBase
    {
        public DotNet()
        {
            this.DotNetReplies = new HashSet<DotNetReply>();
            this.DotNets1 = new HashSet<DotNet>();
        }
        ...
        public virtual ICollection<DotNet> DotNets1 { get; set; }
        public virtual DotNet DotNet1 { get; set; }
