...
namespace MainProgram.Edm
{
    ...
    public partial class Angular : IEntityBase
    {
        public Angular()
        {
            this.AngularReplies = new HashSet<AngularReply>();
            this.Angulars1 = new HashSet<Angular>();
        }
        ...
        public virtual ICollection<Angular> Angulars1 { get; set; }
        public virtual Angular Angular1 { get; set; }
