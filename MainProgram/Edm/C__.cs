...
namespace MainProgram.Edm
{
    ...
    public partial class C__ : IEntityBase
    {
        public C__()
        {
            this.C__1 = new HashSet<C__>();
        ...
        public string C__Text { get; set; }
        public string C__Title { get; set; }
        ...
        public Nullable<int> C___C__Id { get; set; }
        public string C__SKu { get; set; }
        ...
        public virtual ICollection<C__> C__1 { get; set; }
        public virtual C__ C__2 { get; set; }
