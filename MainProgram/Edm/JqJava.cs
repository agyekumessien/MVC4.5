...
namespace MainProgram.Edm
{
    ...
    public partial class JqJava : IEntityBase
    { 
        public JqJava()
        {
            this.JqJavaReplies = new HashSet<JqJavaReply>();
            this.JqJavas1 = new HashSet<JqJava>();
        }
        ...
        public virtual ICollection<JqJava> JqJavas1 { get; set; }
        public virtual JqJava JqJava1 { get; set; }
