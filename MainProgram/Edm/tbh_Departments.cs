...
namespace MainProgram.Edm
{
    ...
    public partial class tbh_Departments : IEntityBase
    {
        public tbh_Departments()
        {
            ...
            this.tbh_Communications = new HashSet<tbh_Communications>();
            this.tbh_Departments1 = new HashSet<tbh_Departments>();
            this.tbh_DSReplies = new HashSet<tbh_DSReplies>();
            this.tbh_FrontSlider = new HashSet<tbh_FrontSlider>();
            this.tbh_Gallery = new HashSet<tbh_Gallery>();
            this.tbh_Pages = new HashSet<tbh_Pages>();
            this.tbh_Products = new HashSet<tbh_Products>();
            this.tbh_Replies = new HashSet<tbh_Replies>();
            this.tbh_Services = new HashSet<tbh_Services>();
            this.tbh_Shop = new HashSet<tbh_Shop>();
            this.tbh_SubDepartments = new HashSet<tbh_SubDepartments>();
        ...
        public Nullable<int> tbh_Departments2_Id { get; set; }
        ...
        public virtual ICollection<tbh_Communications> tbh_Communications { get; set; }
        public virtual ICollection<tbh_Departments> tbh_Departments1 { get; set; }
        public virtual tbh_Departments tbh_Departments2 { get; set; }
        ...
        public virtual ICollection<tbh_Gallery> tbh_Gallery { get; set; }
        ...
        public virtual ICollection<tbh_Services> tbh_Services { get; set; }
        public virtual ICollection<tbh_Shop> tbh_Shop { get; set; }
        public virtual ICollection<tbh_SubDepartments> tbh_SubDepartments { get; set; }
