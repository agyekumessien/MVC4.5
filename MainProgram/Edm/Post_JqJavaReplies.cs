...
namespace MainProgram.Edm
{
    ...
    public partial class Post_JqJavaReplies : IEntityBase
    {
        public Post_JqJavaReplies()
        {
            this.Post_JqJavaReplies1 = new HashSet<Post_JqJavaReplies>();
        }
        ...
        public Nullable<int> Post_JqJava_Id { get; set; }
        public Nullable<int> Post_JqJavaReplies2_Id { get; set; }
        ...
        public virtual ICollection<Post_JqJavaReplies> Post_JqJavaReplies1 { get; set; }
        public virtual Post_JqJavaReplies Post_JqJavaReplies2 { get; set; }
