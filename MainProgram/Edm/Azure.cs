...
namespace MainProgram.Edm
{
    ...
    public partial class Azure : IEntityBase
    {
        public Azure()
        {
            this.AzureReplies = new HashSet<AzureReply>();
            this.Azures1 = new HashSet<Azure>();
        }
        ...
        public string AzureText { get; set; }
        public string AzureTitle { get; set; }
        ...
        public Nullable<int> Azure_AzureId { get; set; }
        ...
        public virtual ICollection<Azure> Azures1 { get; set; }
        public virtual Azure Azure1 { get; set; }
