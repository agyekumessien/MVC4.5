...
namespace MainProgram.Edm
{
    ...
    public partial class Post_Question : IEntityBase
    {
        public Post_Question()
        {
            this.Post_QReplies = new HashSet<Post_QReplies>();
            this.Post_Question1 = new HashSet<Post_Question>();
        }
        ...
        public string PostQText { get; set; }
        public string PostQTitle { get; set; }
        ...
        public Nullable<int> Post_Question_PostQId { get; set; }
        ...
        public Nullable<int> Post_Question2_Id { get; set; }
        ...
        public virtual ICollection<Post_Question> Post_Question1 { get; set; }
        public virtual Post_Question Post_Question2 { get; set; }
