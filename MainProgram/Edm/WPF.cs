...
namespace MainProgram.Edm
{
    ...
    public partial class WPF : IEntityBase
    {
        public WPF()
        {
            this.WPFReplies = new HashSet<WPFReply>();
            this.WPFs1 = new HashSet<WPF>();
        }
        ...
        public string WPFText { get; set; }
        public string WPFTitle { get; set; }
        ...
        public Nullable<int> WPF_WPFId { get; set; }
        public string WPFSKu { get; set; }
        ...
        public virtual ICollection<WPF> WPFs1 { get; set; }
        public virtual WPF WPF1 { get; set; }
    }
}
