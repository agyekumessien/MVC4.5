...
namespace MainProgram.Edm
{
    ...
    public partial class Post_QReplies : IEntityBase
    {
        public Post_QReplies()
        {
            this.Post_QReplies1 = new HashSet<Post_QReplies>();
        }
        ...
        public Nullable<int> Post_QReplies2_Id { get; set; }
        public Nullable<int> Post_Question_Id { get; set; }
