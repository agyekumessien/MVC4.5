...
namespace MainProgram.Edm
{
    ...
    public partial class WebApiReply : IEntityBase
    {
        public WebApiReply()
        {
            this.WebApiReplies1 = new HashSet<WebApiReply>();
        }
        ...
        public Nullable<int> WebApiReply1_Id { get; set; }
        ...
        public virtual ICollection<WebApiReply> WebApiReplies1 { get; set; }
        public virtual WebApiReply WebApiReply1 { get; set; }
