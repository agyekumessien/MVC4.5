...
namespace MainProgram.Edm
{
    ...
    public partial class AngularReply : IEntityBase
    {
        public AngularReply()
        {
            this.AngularReplies1 = new HashSet<AngularReply>();
        }
        ...
        public Nullable<int> AngularReply1_Id { get; set; }
        public Nullable<int> AspNetUsers_Id { get; set; }
        public Nullable<int> tbh_Departments_Id { get; set; }
    
        public virtual ICollection<AngularReply> AngularReplies1 { get; set; }
        public virtual AngularReply AngularReply1 { get; set; }
        public virtual Angular Angular { get; set; }
