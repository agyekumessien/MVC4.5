...
namespace MainProgram.Edm
{
    ...
    public partial class NoSql : IEntityBase
    {
        public NoSql()
        {
            this.NoSqlReplies = new HashSet<NoSqlReply>();
            this.NoSqls1 = new HashSet<NoSql>();
        }
        ...
        public string NoSqlText { get; set; }
        public string NoSqlTitle { get; set; }
        ...
        public Nullable<int> NoSql_NoSqlId { get; set; }
        public string NoSqlSKu { get; set; }
        ...
        public virtual ICollection<NoSql> NoSqls1 { get; set; }
        public virtual NoSql NoSql1 { get; set; }
