...
namespace MainProgram.Edm
{
    ...
    public partial class NetCore : IEntityBase
    {
        public NetCore()
        {
            this.NetCoreReplies = new HashSet<NetCoreReply>();
            this.NetCores1 = new HashSet<NetCore>();
        }
        ...
        public virtual ICollection<NetCore> NetCores1 { get; set; }
        public virtual NetCore NetCore1 { get; set; }
