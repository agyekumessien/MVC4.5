...
namespace MainProgram.Edm
{
    ...
    public partial class Post_DBReplies : IEntityBase
    {
        public Post_DBReplies()
        {
            this.Post_DBReplies1 = new HashSet<Post_DBReplies>();
        }
        ...
        public Nullable<int> Post_Databases_Id { get; set; }
        public Nullable<int> Post_DBReplies2_Id { get; set; }
        ...
        public virtual ICollection<Post_DBReplies> Post_DBReplies1 { get; set; }
        public virtual Post_DBReplies Post_DBReplies2 { get; set; }
