...
namespace MainProgram.Edm
{
    ...
    public partial class MVCReply : IEntityBase
    {
        public MVCReply()
        {
            this.MVCReplies1 = new HashSet<MVCReply>();
        }
    
        public int Id { get; set; }
        public int MVCRId { get; set; }
        public string MVCRText { get; set; }
        public string MVCRTitle { get; set; }
        ...
        public string MVCRSku { get; set; }
        public string Title { get; set; }
        public string ImagePath { get; set; }
        public string LanguageName { get; set; }
        public string UserName { get; set; }
        public Nullable<int> MVCReplies_MVCRId { get; set; }
        public string Reply { get; set; }
        public int TID { get; set; }
        public Nullable<int> AspNetUsers_Id { get; set; }
        public Nullable<int> MVCReply1_Id { get; set; }
        ...
        public virtual ICollection<MVCReply> MVCReplies1 { get; set; }
        public virtual MVCReply MVCReply1 { get; set; }
        public virtual MVC MVC { get; set; }
