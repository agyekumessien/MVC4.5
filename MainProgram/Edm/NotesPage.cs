...
namespace MainProgram.Edm
{
    ...
    public partial class NotesPage : IEntityBase
    {
        public NotesPage()
        {
            this.NotesPageReplies = new HashSet<NotesPageReply>();
            this.NotesPages1 = new HashSet<NotesPage>();
        }
        ...
        public string NotesPageText { get; set; }
        public string NotesPageTitle { get; set; }
        ...
        public Nullable<int> NotesPage_NotesPageId { get; set; }
        public string NotesPageSKu { get; set; }
        ...
        public virtual ICollection<NotesPage> NotesPages1 { get; set; }
        public virtual NotesPage NotesPage1 { get; set; }
